...
# rename columns, reorder facto levels (e.g., Undergraduate before Graduate)
distance <- distance %>%
...
With the data in a tidy format you can now do...pretty much whatever you want with it! In these examples, I chose to visualize it, which demonstrates how - thanks to tidy data(!) - you can recycle the same code with slight alterations to make different plots.
